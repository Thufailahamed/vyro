...
import { poReturnsRouter, returnsRouter, adminReturnsRouter } from './modules/returns/routes';
import orderLifecycleConfigRouter from './modules/orders/configRoutes';
...
import financeAdminRouter from './modules/finance/admin';
import financeSettlementsRouter from './modules/finance/adminSettlements';
...
import crossBorderKycRouter from './modules/admin/crossBorderKycRoutes';
...
import crmRouter from './modules/rfqs/crmRoutes';
...
import businessAddressesRouter from './modules/addresses/routes';
import orderListsRouter from './modules/orderLists/routes';
import supplierProductImportRouter from './modules/supplierProducts/importExport';
...
app.route('/api/businesses', businessAddressesRouter);
...
app.route('/api/supplier-products', supplierProductImportRouter);
...
app.route('/api/order-lists', orderListsRouter);
app.route('/api/purchase-orders', poRouter);
app.route('/api/purchase-orders', poReturnsRouter);
app.route('/api/returns', returnsRouter);
app.route('/api/admin/returns', adminReturnsRouter);
app.route('/api/admin/order-lifecycle', orderLifecycleConfigRouter);
...
app.route('/api/admin/finance', financeAdminRouter);
app.route('/api/admin/finance', financeSettlementsRouter);
...
app.route('/api/admin/cross-border-kyc', crossBorderKycRouter);
