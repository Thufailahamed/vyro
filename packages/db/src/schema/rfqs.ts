...
export const rfqs = sqliteTable(
  'rfqs',
  {
    ...
    awardedQuoteVersion: integer('awarded_quote_version'),
...
export const quoteCounterOffers = sqliteTable(
  'quote_counter_offers',
  {
    ...
    proposedDeliveryFeeCents: integer('proposed_delivery_fee_cents'),
    proposedPaymentTerms: text('proposed_payment_terms'),
    proposedDeliveryDate: integer('proposed_delivery_date'),
