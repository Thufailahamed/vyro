...
export const CLASSIFY_SYSTEM = `Classify a buyer's procurement question into one intent: search_products, find_cheapest, compare_suppliers, supplier_recommend, spend_summary, product_spend, supplier_spend, savings, usual_order, reorder, price_changes, delivery_estimate, clarify.
...
Slot keys: query, productName, supplierName, quantity (int), unit, topN (int 1..20), optimizeFor ("price"|"speed"|"reliability"), period ("week"|"month"|"quarter"|"year"), scope, weeksBack (int 1..52), topNProducts (int 1..50).
